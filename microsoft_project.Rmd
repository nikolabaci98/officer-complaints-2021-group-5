...
Data for Philadelphia can be found [1](), [2](), [3](), [4]() and [5]().
...
```{r NYC-Complaint-Animation-Over-Years}
...
#### NYC
```{r NYC-Complaint-Distribution-By-Race}
...
```{r Chicago-Complaint-Distribution-By-Race}
...
#### NYC
```{r NYC-Distribution-of-Complainants-by-Officer-Race}
...
```{r Chicago-Distribution-of-Complainants-by-Officer-Race}
chicago_complaniant <- read.csv("data/complaints-complainants.csv") %>%
